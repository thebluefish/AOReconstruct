...
protected:
	...
	virtual void _newPSTPickerOnFileChanged(wxFileDirPickerEvent& event) { event.Skip(); }
	virtual void _disableAxsOneButtonOnButtonClick(wxCommandEvent& event) { event.Skip(); }
	virtual void _reconstituteButtonOnButtonClick(wxCommandEvent& event) { event.Skip(); }
	virtual void _pickerPSTOnFileChanged(wxFileDirPickerEvent& event) { event.Skip(); }
	virtual void _buttonRebuildOnButtonClick(wxCommandEvent& event) { event.Skip(); }
